...
export class init1670552330487 implements MigrationInterface {
    name = 'init1670552330487'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "trazos"."trazo" ADD CONSTRAINT "FK_a49d5a6f205a89caee5690bc6df" FOREIGN KEY ("id_usuario") REFERENCES "usuarios"."usuario"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "trazos"."paso" ADD CONSTRAINT "FK_f8ffbdafe4dcd4d1717d3239dac" FOREIGN KEY ("id_trazo") REFERENCES "trazos"."trazo"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
